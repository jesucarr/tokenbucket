...
TokenBucket = (function() {
  var addTokens, errors, hasRedisOptions;
  ...
  hasRedisOptions = function() {
    return (this.redis != null) && (this.redis.bucketName != null) && (this.redis.redisClient != null);
  };
  ...
  /**
    ...
    * @fulfil {Number} - the remaining tokens number
    * @reject {Error}
